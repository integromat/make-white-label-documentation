---
description: >-
  Explore how to navigate and administrate your White Label instance as an OEM
  customer.
---
...
{% hint style="info" %}
You may find the [Make API documentation](https://app.gitbook.com/s/LXp8X1eBwkwrLIWrN9cg/) to be a valuable reference for understanding and effectively utilizing the available API features.
{% endhint %}
...
* [Installing and managing native apps](install-and-configure-apps/)
* [Configuring single sign-on](manage-login/configure-single-sign-on/)
* [Creating and managing organizations](manage-organizations-and-teams/)
* [Customizing your instance](customize-your-instance/)
* [Configuring JWT Authorization](configure-jwt-authorization/enable-jwt-authorization/)
* [Provisioning and managing end-user lifecycle](manage-the-end-user-life-cycle/)

Access and management:

* [Organizations](manage-organizations-and-teams/)
* [Scenarios](audit-activity/view-recently-created-scenarios/)
* [Recent executions](audit-activity/access-recent-executions/)

User roles:

* [Managing user access roles](manage-organizations-and-teams/manage-instance-level-user-access-roles/customize-user-roles.md)
